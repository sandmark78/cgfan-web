...
"hard_constraints": [
"仅限恰好3个主体：一名女性、一名男性，以及一名婴儿（婴儿/幼儿）。",
"成年情侣的脸部必须与上传的参考图像尽可能相似（不得进行变形）。",
"与参考构图一致：极端低角度的英雄镜头，男子肩扛女子。",
"女性安全地抱牢婴儿，并将婴儿略微向上抬起（安全、写实的抬升；不过分）。",
"一架商用客机必须清晰可见地在头顶的天空中（画面顶部区域）。",
"无文本、无徽标、无水印。",
"真实解剖结构（无多余的手臂/手指），鞋类和衣物的褶皱要真实。"
],
"camera": {
"style": "cinematic travel lifestyle photo",
"lens": "24mm",
"aperture": "f/2.8",
"focus": "焦点清晰于情侣脸庞和婴儿，向鞋部略有衰减",
