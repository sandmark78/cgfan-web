...
export function TasteCard() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div
        ref={cardRef}
        className="mx-auto max-w-md overflow-hidden rounded-lg shadow-2xl"
      ...
      >
        ...
        <div className="p-10 text-[#F2F0E9]">
          ...
          <div className="mt-16">
            ...
            <h2
              className="mt-2 font-serif font-black text-white"
              style={{
          ...
          <div className="mt-8 flex items-end justify-between">
            ...
            <div
              className="grid h-[72px] w-[72px] place-items-center rounded-[10px] border-[3px] font-serif text-2xl font-black"
              style={{
