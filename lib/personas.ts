...
const P = (
  ...
  deep = false,
  evolvesFrom?: string
): Persona => ({ id, name, en, tagline, quote, accent, seal, cats, tags, tagW, deep, evolvesFrom, vector })
