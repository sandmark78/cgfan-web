...
export const dailyFeatures: DailyFeature[] = [
  {
    ...
    curatorNote: '这条提示词最值得称道的是对‘动作骨架’的精密定义——侧身回眸、重心后移、双手清晰可见，直接解决了AI人像常见的姿态僵化和手部畸形问题。同时，它聪明地利用参考图仅借光质和构图，而非复制人物，避免了版权风险。冷蓝调高纬度夜景与海风动态的结合，让画面兼具叙事张力和技术可控性，适合需要电影感定帧的编辑、品牌或概念摄影场景。',
    highlight: '精密动作骨架+参照光效，破解AI人像姿态与手部难题',
    technique: '动作骨架约束 · 低光冷色调 · 35mm胶片颗粒 · 动态风感',
    tip: '在提示词中显式定义‘动作骨架’（如重心腿、回眸角度、手部位置），可大幅提升姿态自然度与一致性，尤其适合全身人像。',
    tryChange: '将‘冬夜海滩’改为‘雪夜桦树林’，保留冷蓝调与回眸动作，测试场景迁移对氛围和服装质感的影响。',
  },
  {
    date: '2026-08-13',
