...
export const dailyFeatures: DailyFeature[] = [
  {
    date: '2026-08-09',
    slug: 'dynasty-editorial-poster-framework',
    curatorNote: '这条提示词的核心价值在于把「朝代策展」从笼统的古风堆砌升级为一套可参数化的视觉系统。它用「人物设定—朝代符号—材质工艺—色彩体系—构图叙事」五层递进结构，让AI不是在画一张古风图，而是在策划一场博物馆级的朝代展览。特别是对「信息层级」的强调——标题字体、副标题、标签、留白比例都被纳入设计参数，让输出具备真正的编辑设计感。色彩上克制在朱砂、墨黑、鎏金、宣纸白四色系内，用材质反光（丝绸光泽、金属质感）制造层次而非堆色。',
    highlight: '把朝代美学从古风堆砌升级为博物馆级策展系统',
    technique: '朝代符号参数化 · 四色系克制配色 · 材质光泽分层 · 编辑级排版',
    tip: '写东方美学prompt时，用「朝代+具体器物」替代笼统的「古风」——比如「唐代鎏金凤冠」比「古代首饰」精准十倍，AI能调出正确的历史质感。',
    tryChange: '把「鎏金+朱砂」换成「青瓷+月白」，从盛唐华丽转向宋瓷清冷，观察色彩体系如何重塑朝代气质。',
  },
  {
    date: '2026-08-08',
