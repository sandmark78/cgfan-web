...
export const dailyFeatures: DailyFeature[] = [
  {
    ...
    curatorNote: '这条提示词的高明之处在于将字体设计升级为可交互的物理雕塑，并提供了4个高度具体的场景蓝图，让AI从“画一个字母”转向“构建一个空间叙事”。它精准利用GPT-Image2对深度、光影和材质的理解力，通过“BREAK THE TYPE”“GRIP THE FORM”等方向定义角色、字母、互动方式甚至色彩倾向，实现了从抽象概念到成片级视觉的跳跃。适合时尚品牌创意、杂志封面或装置艺术视觉化，尤其是需要将平面字体转化为戏剧性实景的诉求。',
    highlight: '把字母变成雕塑，让身体与字体产生真实的重量、穿透与支撑关系。',
    technique: '3D字体雕塑化 · 人体-结构物理互动 · 工作室布光 · 分层深度 · 克制色系',
    tip: '用“方向列表”定义多个具体场景（角色+字母+互动+色彩），比单一描述更能激发AI的构图多样性，且可互换参数快速迭代。',
    tryChange: '将“暗绿色G”改为“磨砂亚克力透明G”，让腿部穿透时产生折射阴影，增加材质趣味性。',
  },
  {
    date: '2026-08-03',
