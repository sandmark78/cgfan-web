...
export const dailyFeatures: DailyFeature[] = [
  {
    ...
    curatorNote: '这份提示词像一份设计简报与工程清单的合体——把大众点评商户通6类物料拆成独立模块，又用统一的品牌配色、字体、摄影风格强力黏合。其精妙在于：每类物料都有独立背景和边界，却共享同一套视觉语言，真正做到了‘可拆分、可延续’。适合商业提案、品牌全案、作品集展示，尤其适合需要同时说服客户与落地执行的场景。',
    highlight: '六类物料案板一次出齐，模块化设计兼具提案力与落地性',
    technique: '模块化布局 · 品牌配色统一 · 真实餐饮摄影 · 克制信息层级',
    tip: '用「物料清单+视觉规范」双结构写提示词，既能控制生成结果的一致性，又为后续拆分完善留出操作空间。',
    tryChange: '试着将「真实餐饮摄影」改为「3D渲染风格」，观察材质与光效如何统一六类物料。',
  },
  {
    date: '2026-08-05',
