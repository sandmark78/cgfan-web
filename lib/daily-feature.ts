...
export const dailyFeatures: DailyFeature[] = [
  {
    ...
    curatorNote: '这是一套融合「纸雕层叠工艺 + 东方幻想世界观 + 山海经神话体系」的完整提示词框架。 核心技法：纸雕/纸艺层叠、立体切纸边缘、压纹纸张质感、浮雕阴影。 提示词按构图→场景→风格→色彩→文字五层递进，结构清晰，可复用性强。 实测 GPT-Image2 可稳定输出，适合作为海报类提示词的基准模板。',
    highlight: '纸雕层叠工艺 · 东方幻想世界观 · 纸雕东方幻想：山海经异兽神话海报',
    technique: '纸雕/纸艺层叠 · 立体切纸边缘 · 压纹纸张质感',
    tip: '用「【】」分段标记（如【整体构图】【色彩】）能大幅提升 AI 对复杂提示词的结构理解。',
    tryChange: '把「深蓝+暖金」改成「墨绿+银灰」，从东方神话转向神秘森林氛围。',
  },
