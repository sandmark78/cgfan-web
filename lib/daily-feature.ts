...
export const dailyFeatures: DailyFeature[] = [
  {
    ...
    curatorNote: '这个框架的独特之处在于它把「解构故事」前置为生成逻辑，而不是让AI直接看图猜剧情。它通过人物关系、核心冲突、关键物件等结构化字段，让封面从叙事中生长出来，而非套用模板。更聪明的是对「出版感」的强调——字体、排版、信息层级被纳入设计参数，让AI生成的封面不再是孤立的画，而是一本真实存在的书。这对需要批量产出概念封面、书籍营销图的编辑和设计师尤其实用。',
    highlight: '先解构故事，再生成封面，让AI从剧情中长出真正的设计。',
    technique: '叙事要素结构化 · 电影感景深分层 · 出版级字型编排',
    tip: '把「一句话场景」升级为「三行分镜」——前景动作、中景人物关系、远景环境各写一句，让AI生成的空间层次更接近真实电影长镜头。',
    tryChange: '试着将「真实摄影感」改为「浮世绘版画质感」，提炼出完全不同的东方故事美学。',
  },
  {
    date: '2026-08-08',
