...
export const dailyFeatures: DailyFeature[] = [
  {
    ...
    curatorNote: '关键技法：东方。 符合「东方美学」的偏好方向。 使用 GPT-Image2 模型。',
    highlight: '纸雕东方幻想：山海经异兽神话海报...',
    technique: 'poster · AI绘图',
    tip: '关键技法「东方」是精准控制输出质量的核心词。',
    tryChange: '把核心材质或光线词换一个方向，观察整体氛围的变化。',
  },
