        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {popularPrompts.map((prompt, index) => (
            ...
            >
              ...
              <div className="p-3">
                <h3 className="line-clamp-2 text-sm font-medium text-gray-900 dark:text-white">{prompt.title}</h3>
                <div className="mt-2 flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                  <span className="rounded-full bg-gray-100 px-2 py-0.5 dark:bg-gray-800">{prompt.model}</span>
